  ...
  agent any
     stages {
         ...
         stage('Ansbile config and Deployment') {
               steps {
                 ansiblePlaybook credentialsId: 'swetha-ssh2', disableHostKeyChecking: true, installation: 'ansible', inventory: '/etc/ansible/hosts', playbook: 'ansible.yml', vaultTmpPath: ''
